...
import 'package:fit_kit/tdee_result_screen.dart';
import 'package:flutter/material.dart';
import 'constants.dart';

class tdeeScreen extends StatefulWidget {
  tdeeScreen({required this.title});
  final String title;
              ...
              child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => tdeeResults(gender(),
                                heightValue, weightValue, ageValue, activity)));
                  },
                  style: ElevatedButton.styleFrom(
